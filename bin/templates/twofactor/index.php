...
<div class="row l1">
	<div class="span l1">
		...
		<div class="padded">
			...
			<div class="separator"></div><div class="padded">
				<div class="row l9">
					<div class="span l1 desktop-only text:grey-700 align-center">
						<div class="spacer small"></div>
					...
					<div class="span l8">
						<h2 class="text:grey-700">Password</h2>
						<p>
							A secure password will help to reduce the ability of others to access your account.
						...
						<div>
							<span class="text:grey-700"><small>Last changed <?= date('M Y', $password->created) ?></small></span>
						</div>
						<?php endforeach ?>
				...
				<div class="align-right">
					<a class="button" href="<?= url(mfa\PasswordController::class, 'set') ?>">Change your password</a>
				</div>
