...
namespace mail {
	...
	class MailhogTransport implements TransportInterface
	{
		private $mailer;
		...
		{
			$this->mailer->setFrom('system@localhost.mail', 'The finest drinks served right at home');
			$this->mailer->isHTML(true);
			$this->mailer->clearAllRecipients();
			$this->mailer->addAddress($model->to);
			$this->mailer->Subject = $model->subject;
			$this->mailer->Body = $model->body;
