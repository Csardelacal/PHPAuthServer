...
class HomeController extends BaseController
{
	public function index() {
		...
		if (db()->table('user')->getAll()->count() < 1) { return $this->response->setBody('Redirecting...')->getHeaders()->redirect(new URL('setup')); }
		...
		else                      { return $this->response->setBody('Redirecting...')->getHeaders()->redirect(new URL('user', 'login')); }
	}
}
